...
@interface TestH5BridgeViewController ()<WKNavigationDelegate,HETWKWebViewJavascriptBridgeDelegate>
...
@implementation TestH5BridgeViewController
...
-(void)config:(id)data
{
    [_bridge webViewConfigDataRepaint:@{@"config":data}];
}
...
- (void)load {
    _requestURL=[NSURL URLWithString:@"http://10.8.9.133/front/trunk/mobile/cSleep/page/index.html"];
...
- (void)updateWebOrientation {
    ...
    if (UIInterfaceOrientationIsLandscape(orientation)) {
        ...
        [_webView evaluateJavaScript:@"document.body.setAttribute('orientation', 90);" completionHandler:nil];
    } else {
        //[_webView stringByEvaluatingJavaScriptFromString:
        // @"document.body.removeAttribute('orientation');"];
        [_webView evaluateJavaScript:@"document.body.removeAttribute('orientation');" completionHandler:nil];
    }
}
...
-(void)updateDataSuccess:(id)data :(id)successCallBlock {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [_webView evaluateJavaScript:[NSString  stringWithFormat:@"webInterface.nativeResponse('%@','%@')",messageJSON,successCallBlock] completionHandler:nil];
    });
}
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if([requestString hasPrefix:@"http"]||[requestString hasPrefix:@"file://"])
    {
        ...
        NSRange rangToken=[requestString rangeOfString:@"accessToken"];
